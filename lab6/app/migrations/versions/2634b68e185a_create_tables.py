...
Revision ID: 2634b68e185a
Revises: 
Create Date: 2023-06-13 19:53:22.067577
...
def data_upgrades():
    ...
    table1 = sa.sql.table('grades', sa.sql.column('name', sa.String), sa.sql.column('name_id', sa.Integer)) 
    op.bulk_insert(table1,
        [
            { 'name': 'Отлично', 'name_id': 5 },
            { 'name': 'Хорошо', 'name_id': 4 },
            { 'name': 'Удовлетворительно', 'name_id': 3 },
            { 'name': 'Неудовлетворительно', 'name_id': 2 },
            { 'name': 'Плохо', 'name_id': 1 },
            { 'name': 'Ужасно', 'name_id': 0 },
        ]
    )